...
import './Admin_SolicitudesClub.css';
...
const Admin_SolicitudesClub: React.FC = () => {
  const { user } = useAuth();
        ...
        <div className="admin-solicitudes-container">
          <div className="admin-solicitudes-header">
            <h1>
              ...
              Gestión de Solicitudes de Club
            </h1>
            ...
            <IonGrid>
              <IonRow>
                {filteredSolicitudes.map((solicitud) => (
                  <IonCol size="12" sizeMd="6" sizeLg="4" key={solicitud.id}>
                    <IonCard className="solicitud-card">
                      <IonCardHeader>
                      ...
                      <IonCardContent>
                        <IonList lines="none">
                          <IonItem>
                            ...
                            <IonLabel>
                              <h3>{solicitud.usuario.nombre} {solicitud.usuario.apellidos}</h3>
                          ...
                          <IonItem>
                            ...
                            <IonLabel>
                              <p>{solicitud.horario_apertura} - {solicitud.horario_cierre}</p>
                            </IonLabel>
                          </IonItem>
                        ...
                        <div className="solicitud-actions" style={{ marginTop: '1rem', display: 'flex', gap: '0.5rem' }}>
                          <IonButton
                            expand="block"
                            fill="outline"
                            size="small"
...
export default Admin_SolicitudesClub;